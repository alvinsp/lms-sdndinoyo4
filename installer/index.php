...
<head>
    ...
    <title>SDN DINOYO 04</title>

    <link rel="shortcut icon" href="<?= $base_url ?>assets/img/sddinoyo.png" type="image/x-icon">
                ...
                <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 aos-init aos-animate"
                    ...
                    <div class="text-center text-md-left">
                        <div class="mb-3 text-white">
                            <img style="width:100px; height:auto;" src="<?= $base_url ?>assets/img/sddinoyo.png"><span
                                class="h1 align-bottom">LMS</span>
                            <span class="h1 align-bottom"> Learning Management System</span>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="#" id="create" method="post" accept-charset="utf-8">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control db" id="input-nama-host" name="hostname"
                                            value="" placeholder="localhost" required="">
                                    </div>
                                    <div class="form-group col-12" required="">
                                        <label for="input-nama-db">Host Username</label>
                                        <input type="text" class="form-control db" id="input-user-host" name="username"
                                            value="" placeholder="Host Username">
                                    </div>
                                    <div class="form-group col-12" required="">
                                        <label for="input-nama-db">Host Password</label>
                                        <input type="text" class="form-control" id="input-pass-host" value=""
                                            name="password" placeholder="Host Password">
                                        <small class="form-text text-muted">Kosongkan jika tidak menggunakan password.
                                        </small>
                                    </div>
                                    <div class="form-group col-12" required="">
                                        <label for="input-nama-db">Nama Database</label>
                                        <input type="text" class="form-control db" id="input-nama-db" name="database"
                                            value="" placeholder="Nama Database">
                                        <small class="form-text text-muted">Jangan gunakan spasi.</small>
                                    </div>
                                </div>
                                <div class="d-flex flex-wrap align-items-center justify-content-end">
                                    <button type="submit" id="install-db" class="btn-primary btn">INSTALL /
                                        UPDATE</button>
                                </div>
                            </form>
                        </div>
