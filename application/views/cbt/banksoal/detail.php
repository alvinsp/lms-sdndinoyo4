                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <button id="convert" class="btn btn-sm btn-primary">
                            <i class="fas fa-download"></i> <span class="d-none d-sm-inline-block ml-1">Download
                                Soal</span>
                        </button>
                        <a href="<?= base_url('cbtbanksoal/buatsoal/' . $bank->id_bank) ?>" type="button"
                            class="btn btn-sm btn-success">
                            <i class="fas fa-plus"></i> <span class="d-none d-sm-inline-block ml-1">Tambah/Edit
                                Soal</span>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="col-12 mt-1">
                            <div class="alert alert-default-info">
                                ...
                                <span class="badge badge-btn badge-primary">
                                    <i class="fa fa-save"></i> <span class="d-none d-md-inline-block ml-1">Simpan Soal
                                        Terpilih</span>
                                </span>
                                di bawah
                            </div>
            ...
            <div class="card card-default my-shadow mb-4">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="#jodoh" data-toggle="tab">Menjodohkan
                                <?= $badge_jodohkan ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="#isian" data-toggle="tab">Isian
                                Singkat <?= $badge_isian ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="#essai" data-toggle="tab">Essai/Uraian
                                <?= $badge_essai ?></a></li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content">
                                ...
                                <tr class="alert alert-default-danger">
                                    <td colspan="5" class="border-dark">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                Soal sudah dijadwalkan, tidak bisa menghapus dan memilih ulang butir
                                                soal.
                                            </li>
                                            <?php endif; ?>
                                            <?php if ($total_siswa > 0) : ?>
                                            <li>
                                                Soal sedang digunakan oleh siswa, tidak bisa menghapus dan memilih ulang
                                                butir soal.
                                            </li>
                                            <?php endif; ?>
                                        </ul>
                            ...
                            <div class="d-sm-flex justify-content-between mb-3">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary ml-3" id="save-pg">
                                        <i class="fa fa-save"></i> <span class="d-none d-md-inline-block ml-1">Simpan
                                            Soal Terpilih</span>
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div class="rTableRow">
                                        ...
                                        <div class="rTableCell text-right pt-2" style="width: 60px">
                                            ...
                                            <button class="btn btn-sm btn-default" type="button"
                                                data-idsoal="<?= $s->id_soal ?>" data-nomor="<?= $s->nomor_soal ?>"
                                                data-jenis="1" onclick="hapusSoal(this)" <?= $dis ?>>
                            ...
                            <div class="d-sm-flex justify-content-between mb-3">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary ml-3" id="save-pg2">
                                        <i class="fa fa-save"></i> <span class="d-none d-sm-inline-block ml-1">Simpan
                                            Soal Terpilih</span>
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="rTableBody">
                                    ...
                                    <div class="rTableRow">
                                        ...
                                        <div class="rTableCell text-right pt-2" style="width: 60px">
                                            ...
                                            <button class="btn btn-sm btn-default" type="button"
                                                data-idsoal="<?= $s->id_soal ?>" data-nomor="<?= $s->nomor_soal ?>"
                                                data-jenis="2" onclick="hapusSoal(this)" <?= $dis ?>>
                                                <i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                                ...
                                <div class="rTableBody">
                                    ...
                                    <div class="rTableRow">
                                        ...
                                        <div class="rTableCell text-right pt-2" style="width: 60px">
                                            ...
                                            <button class="btn btn-sm btn-default" type="button"
                                                data-idsoal="<?= $s->id_soal ?>" data-nomor="<?= $s->nomor_soal ?>"
                                                data-jenis="3" onclick="hapusSoal(this)" <?= $dis ?>>
                                                <i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                        ...
                        <div class="tab-pane table-responsive" id="isian">
                            ...
                            <div class="d-sm-flex justify-content-between mb-3">
                                <div>
                                    <input style="width: 24px; height: 24px" class="check-isian-all m-1" id="all-isian"
                                        type="checkbox" <?=$dis?>>
                                ...
                                <div class="rTableBody">
                                    ...
                                    <div class="rTableRow">
                                        ...
                                        <div class="rTableCell text-right pt-2" style="width: 60px">
                                            ...
                                            <button class="btn btn-sm btn-default" type="button"
                                                data-idsoal="<?= $s->id_soal ?>" data-nomor="<?= $s->nomor_soal ?>"
                                                data-jenis="4" onclick="hapusSoal(this)" <?= $dis ?>>
                                                <i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                                ...
                                <div class="rTableBody">
                                    ...
                                    <div class="rTableRow">
                                        ...
                                        <div class="rTableCell text-right pt-2" style="width: 60px">
                                            ...
                                            <button class="btn btn-sm btn-default" type="button"
                                                data-idsoal="<?= $s->id_soal ?>" data-nomor="<?= $s->nomor_soal ?>"
                                                data-jenis="5" onclick="hapusSoal(this)" <?= $dis ?>>
                                                <i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                ...
                <table class="table-soal"
                    ...
                    <thead>
                        <tr style="background-color: lightgrey">
                            ...
                            <th
                                style="border: 1px solid black;border-collapse: collapse;  text-align: center; font-weight: bold; padding: 12px">
                                KUNCI
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black; vertical-align: top; padding-left: 6px"><?= $s['opsi_a'] ?>
                        </td>
                        <td style="border: 1px solid black; vertical-align: top; padding-left: 6px">
                            <?= strtolower($s['jawaban']) == 'a' ? 'v' : '' ?></td>
                    </tr>
                    <?php
                        $post_char = 98;
                        for ($a = 0; $a < 4; $a++) :
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black; vertical-align: top; padding-left: 6px">
                            <?= strtolower($s['jawaban']) == $abjad ? 'v' : '' ?></td>
                    </tr>
                ...
                <table class="table-soal"
                    ...
                    <thead>
                        <tr style="border-bottom: 3px solid black; background-color: lightgrey">
                            ...
                            <th
                                style="width:60px; border: 1px solid black;border-collapse: collapse; text-align: center;font-weight: bold; padding: 12px">
                                JENIS
                            </th>
                            <th
                                style="border: 1px solid black;border-collapse: collapse; text-align: center;font-weight: bold; padding: 12px">
...
$(document).ready(function() {
    ...
    $('#save-jodohkan').on('click', function(e) {
        var dataPost = $('#select-jodohkan').serialize() + "&uncheck=" + JSON.stringify(
            jodohkanUnchecked);
        console.log(dataPost);
    ...
    $("#convert").click(function(e) {
        ...
        saveAs(converted,
            'Soal <?= $bank->bank_kode ?> <?= $bank->nama_mapel ?> Kls <?= $bank->bank_level ?>.docx'
            );
