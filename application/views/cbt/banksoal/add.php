                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input id="jml-pg" type='number' name='tampil_pg'
                                                    class='form-control form-control-sm' value="<?= $bank->tampil_pg ?>"
                                                    required />
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input id="bobot-pg" type='number' name='bobot_pg'
                                                    class='form-control form-control-sm' value="<?= $bank->bobot_pg ?>"
                                                    required />
                                            </div>
                                        </div>
                                        <div class="col-5">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input id="bobot-pg2" type='number' name='bobot_kompleks'
                                                    class='form-control form-control-sm'
                                                    value="<?= $bank->bobot_kompleks ?>" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(k, v) {
                        ...
                        opts += '<option value="' + k + '" ' + selected + '>' + v +
                            '</option>';
                    });
                    selGuru.html(opts);
                    idGuru = selGuru.val();
    ...
    function getKelasLevel(level, mapel) {
        ...
        if (idGuru === '' || mapel == null) {
            ...
            $.ajax({
                url: base_url + "cbtbanksoal/getkelaslevel?level=" + level + "&id_guru=" + idGuru +
                    '&mapel=' + mapel,
                type: "GET",
                success: function(data) {
                    ...
                    for (let i = 0; i < kelas.length; i++) {
                        ...
                        selKelas.append(new Option(kelas[i].kode_kelas, kelas[i].id_kelas, false,
                            selected));
                    }
