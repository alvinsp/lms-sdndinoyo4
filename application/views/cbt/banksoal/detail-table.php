            ...
            <div class="card card-default my-shadow mb-4">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#jodoh" data-toggle="tab">Menjodohkan
                                <?= $badge_jodohkan ?></a></li>
                            ...
                            <table id="table-jodohkan" class="table-soal table table-striped mt-3">
                                ...
                                <tr>
                                    ...
                                    <td class="border-0 w-100">
                                        ...
                                        <div class='list-jodohkan' data-list='<?= json_encode($jawaban['jawaban']) ?>'>
                                            <div class="bonds" id="soal<?= $s->id_soal ?>" style="display:block;"></div>
                                        </div>
                                        <?php else : ?>
                                        <table class="table table-bordered">
                                            <?php
