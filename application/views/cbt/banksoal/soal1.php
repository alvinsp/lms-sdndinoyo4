        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row">
                        <h6 class="col-md-6"><b>Bank
                                Soal:</b>
                            <?= $bank->bank_kode . ' | PG: ' . $bank->tampil_pg . ', Essai: ' . $bank->tampil_esai ?>
                        </h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card my-shadow">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link <?= $tab_active == '1' ? 'active' : '' ?>" href="#ganda"
                                data-toggle="tab">Pilihan Ganda</a></li>
                        <li class="nav-item"><a class="nav-link <?= $tab_active == '2' ? 'active' : '' ?>"
                                href="#kompleks" data-toggle="tab">Pilihan Ganda Kompleks</a></li>
                        <li class="nav-item"><a class="nav-link <?= $tab_active == '3' ? 'active' : '' ?>" href="#jodoh"
                                data-toggle="tab">Menjodohkan</a></li>
                        <li class="nav-item"><a class="nav-link <?= $tab_active == '4' ? 'active' : '' ?>" href="#isian"
                                data-toggle="tab">Isian Singkat</a></li>
                        <li class="nav-item"><a class="nav-link <?= $tab_active == '5' ? 'active' : '' ?>" href="#essai"
                                data-toggle="tab">Essai/Uraian</a></li>
                    </ul>
                </div>
                <div class="card-body">
            ...
            <div class="card my-shadow">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <div id="nomor-soal"><b>Soal Nomor: 1</b></div>
                        </div>
                        <div class="col-6">
                            ...
                            <div class="col-md-6" id="jawaban-area">
                                ...
                                <div id="root-opsi-pg" class="<?= $pg_none ?>">
                                    ...
                                    <div class="mb-3 ml-3">
                                        ...
                                        <textarea class="textjawaban" id="textjawaban_<?= $abjad ?>"
                                            name="jawaban_<?= $abjad ?>" placeholder="Place some text here"
                                ...
                                <div class="<?= $jodohkan_none ?> mt-4" id="root-opsi-jodohkan">
                                    ...
                                    <div class="d-flex justify-content-between mb-2">
                                        <b>Jawaban</b>
                                        <?php
                                        $vals = ['- tipe pilihan -', '1 baris berisi banyak jawaban', '1 baris berisi 1 jawaban'];
                                        echo form_dropdown(
                                            'type_opsi',
                                            $vals,
                                            0,
                                            'class="col-4 form-control form-control-sm input-sesi" id="type-opsi" disabled="disabled"'
                                        );
                                        ?>
            ...
            <div class="card my-shadow">
                <div class="card-header">
                    ...
                    <!--
                    <button type="button" data-toggle="modal" data-target="#pickerModal"
                            class="btn btn-outline-primary btn-oval-sm card-tools"><i class="fa fa-plus"></i>
