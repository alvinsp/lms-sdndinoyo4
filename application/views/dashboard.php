...
<div class="content-wrapper bg-white">
    <section class="content-header p-0 d-flex align-items-end"
        style="height: 400px; background: url('<?= base_url('assets/img/wall1.png') ?>')">
                                ...
                                <div class="card-header d-flex p-0">
                                    <ul class="nav nav-pills p-2">
                                        ...
                                        foreach ($kelases as $ky => $kelas) :
                                            $active = $no == 1 ? 'active' : '';
                                            ?>
                                        <li class="nav-item"><a class="nav-link <?= $active ?>" href="#tab_<?= $ky ?>"
                                        ...
                                        <div class="info-box border p-1" style="min-height: 60px">
                                            <div class="info-box-content p-1 text-danger">
                                                <span class="info-box-text">Token
                                                    <small class="float-right d-none" id="interval">-- : -- :
                                                        --</small></span>
                                                <h5 class="info-box-number m-0" id="token-view">
                                                    <?= $token->token != null ? $token->token : '- - - - - -' ?></h5>
                                            </div>
                                        </div>
                                    </a>
                                </div>
