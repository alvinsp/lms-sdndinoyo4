  ...
  <div class="untree_co-hero overlay" style="background-image: url('<?php echo base_url('assets/homeprofile/images')?> /hero-img-1-min.jpg');">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 mr-auto mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="0">
          <img src="<?php echo base_url('assets/homeprofile/images')?> /img-school-5-min.jpg" alt="image" class="img-fluid">
        </div>
                ...
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="<?php echo base_url('assets/homeprofile/images')?> /img-school-1-min.jpg" alt="Image" class="img-fluid">
                    </div>
                    <div>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_1">
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="<?php echo base_url('assets/homeprofile/images')?> /img-school-2-min.jpg" alt="Image" class="img-fluid">
                    </div>
                    <div>
                      <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there
                        live the blind texts. </p>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion_1">
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="<?php echo base_url('assets/homeprofile/images')?> /img-school-3-min.jpg" alt="Image" class="img-fluid">
                    </div>
                    <div>
